...
export default function Decks() {
    ...
    const closeNewCardModal = () => {
        authFetch("http://menews.site:9090/aknowledgeNewCard", {
            method: "POST",
            headers: {
    ...
    const addCardToDeck = (name: string) => {
        ...
        authFetch("http://menews.site:9090/addCardToDeck", {
            method: "POST",
            headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    const removeCardFromDeck = (cardname: string) => {
        ...
        authFetch("http://menews.site:9090/removeCardFromDeck", {
            method: "POST",
            headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    useEffect(() => {
        authFetch("http://menews.site:9090/getDecks").then(response => {
        ...
        authFetch("http://menews.site:9090/getNewCards").then(response => {
            return response.json()
        }).then(r => {
    ...
    function setActiveDeck(deck: Deck) {
        ...
        authFetch("http://menews.site:9090/setActiveDeck", {
            method: "POST",
            headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    function submitDeckCreation(deck: Deck) {
        ...
        authFetch("http://menews.site:9090/createDeck", {
            method: "POST",
            headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    function deleteDeck(deck: Deck) {
        ...
        authFetch("http://menews.site:9090/removeDeck", {
            method: "POST",
            headers: {
                'Accept': 'application/json, text/plain',
                'Content-Type': 'application/json;charset=UTF-8'
