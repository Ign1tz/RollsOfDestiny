...
func UpdateColumn(column Types.Column) error {
	_, err := Database.Exec("Update columns set first = "+
		"$1, second = $2, third = $3 where gridid = $4 and placement = $5", column.First, column.Second, column.Third, column.GridId, column.Placement)
	return err
}
